...
export default function Navbar() {
  ...
  function toggle() {
    setShowMe(!showMe);
    if (showMe) {
      document.getElementById("mobile-menu-4").className =
          ...
          >
            <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li>
                <a
                  href="#"
                  className="block py-2 pr-4 pl-3 text-gray-700 bg-gray-700 rounded md:bg-transparent md:text-gray-700 md:p-0 dark:text-white"
                  aria-current="page"
                >
                  Home
                </a>
