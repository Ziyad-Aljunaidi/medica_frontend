...
export default function Footer() {
  return (
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <a href="https://www.medica72.com" className="flex items-center mb-4 sm:mb-0">
            <Image src="/medica-logo.svg" width={200} height={60} className="mr-3 h-8" alt="Medica Logo" />
        </a>
